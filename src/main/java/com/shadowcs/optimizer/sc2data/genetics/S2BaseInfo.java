...
public class S2BaseInfo {
    ...
    public S2BaseInfo(boolean richMinerals, boolean richVespene) {
        this(richMinerals, richVespene, richMinerals ? 8100: 10800, 2250, richVespene ? 0: 2250);
    }

    public S2BaseInfo(boolean richMinerals, boolean richVespene, float minerals, float vespene1, float vespene2) {
